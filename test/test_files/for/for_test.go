...
func Example_scope() {
	if err := r.RunFile("scope.lox"); err != nil {
		fmt.Println(err)
	}
...
func Test_statement_condition(t *testing.T) {
	if err := r.RunFile("statement_condition.lox"); err != nil {
		t.Log(SUCCESS_TEXT+":", err)
	} else {
		t.Error(FAILED_TEXT)
	}
...
func Test_statement_increment(t *testing.T) {
	if err := r.RunFile("statement_increment.lox"); err != nil {
		t.Log(SUCCESS_TEXT+":", err)
	} else {
		t.Error(FAILED_TEXT)
	}
...
func Test_statement_initializer(t *testing.T) {
	if err := r.RunFile("statement_initializer.lox"); err != nil {
		t.Log(SUCCESS_TEXT+":", err)
	} else {
		t.Error(FAILED_TEXT)
	}
